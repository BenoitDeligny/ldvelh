export const screensData = {
    'screen_a': [
        ...
        { content: '3',  top: '78%', left: '10%', type: 'greenNumber' },
        { content: '4',  top: '40%', left: '45%', type: 'orangeNumber' },
        { content: '5',  top: '85%', left: '50%', type: 'greenNumber' },
        { content: '6',  top: '18%', left: '60%', type: 'greenNumber' },
        { content: '7',  top: '60%', left: '75%', type: 'orangeNumber' },
    ...
    'screen_b': [
        ...
        { content: '14', top: '70%', left: '30%', type: 'orangeNumber' },
        { content: '15', top: '90%', left: '20%', type: 'greenNumber' },
        { content: '16', top: '20%', left: '50%', type: 'greenNumber' },
        { content: '17', top: '45%', left: '65%', type: 'greenNumber' },
    ...
    'screen_c': [
        ...
        { content: '24', top: '85%', left: '25%', type: 'greenNumber' },
        { content: '25', top: '15%', left: '55%', type: 'greenNumber' },
        { content: '26', top: '35%', left: '70%', type: 'greenNumber' },
        { content: '27', top: '55%', left: '85%', type: 'greenNumber' },
